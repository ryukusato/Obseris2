...
public class HumanPlayer implements Player {
    ...
    private boolean prevSoftDrop = false;
    public HumanPlayer() {}
    ...
    private void handleSinglePressActions(InputState state) {
        ...
        if (state.softDrop && !prevSoftDrop) {
            actionQueue.offer(GameAction.START_SOFT_DROP);
        }
        if (!state.softDrop && prevSoftDrop) {
            actionQueue.offer(GameAction.STOP_SOFT_DROP);
        }
    }
